...
class Age2ItemData(enum.IntEnum):
    ...
    TECH_EXORCISM                           = 3624, "Faith",                             Tech(45, 45, -1, Age2AgeData.IMPERIAL, False, False)
    TECH_DEVOTION                           = 3625, "Devotion",                             Tech(46, 46, -1, Age2AgeData.CASTLE, False, False)
    TECH_FLAMING_ARROWS                     = 3626, "Chemistry",                       Tech(47, 47, -1, Age2AgeData.IMPERIAL, False, False)
    ...
    TECH_BASTION                            = 3637, "Keep",                              Tech(63, 63, -1, Age2AgeData.IMPERIAL, False, False)
    ...
    TECH_TARGET_PRACTICE                    = 3650, "Ballistics",                      Tech(93, 93, -1, Age2AgeData.CASTLE, False, False)
    ...
    TECH_HARUSPICY                          = 3674, "Block Printing",                            Tech(230, 220, -1, Age2AgeData.IMPERIAL, False, False)
    TECH_AMULET_PROTECTION                  = 3675, "Sanctity",                    Tech(231, 221, -1, Age2AgeData.CASTLE, False, False)
    TECH_PURIFICATION                       = 3676, "Illumination",                         Tech(233, 219, -1, Age2AgeData.IMPERIAL, False, False)
    ...
    TECH_SACRIFICIAL_DEDICATION             = 3692, "Redemption",               Tech(316, 316, -1, Age2AgeData.CASTLE, False, False)
    TECH_SYNCRETISM                         = 3693, "Atonement",                           Tech(319, 319, -1, Age2AgeData.CASTLE, False, False)
    ...
    TECH_LIGHTHOUSE                         = 3716, "Heated Shot",                           Tech(380, 378, -1, Age2AgeData.CASTLE, False, False)
    ...
    TECH_MYSTERY_CULTS                      = 3727, "Theocracy",                        Tech(438, 494, -1, Age2AgeData.IMPERIAL, False, False)
    TECH_HEMLOCK                            = 3728, "Heresy",                              Tech(439, 188, -1, Age2AgeData.CASTLE, False, False)
