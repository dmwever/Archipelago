...
def set_rules(world: Age2World) -> None:
    ...
    buildingRules: BuildingRules = BuildingRules()
    ageRules: AgeRules = AgeRules()
    
    buildingRules.set_rules(world)
    ageRules.set_building_ages(world)
    
    world.set_rule(world.get_location(Age2ScenarioLocationData.ATT1_VICTORY.global_name()),
             (attila_camp | bleda_camp) & ageRules.can_reach_castle)
    ...
    world.set_rule(world.get_location(Age2ScenarioLocationData.ATT1_DEFEAT_FIRST_PLAYER.global_name()),
             (attila_camp | bleda_camp) & ageRules.can_reach_feudal)
    world.set_rule(world.get_location(Age2ScenarioLocationData.ATT1_CAPTURE_HORSES_CAMP.global_name()), bleda_camp)
    world.set_rule(world.get_location(Age2ScenarioLocationData.ATT2_VICTORY.global_name()), attila_2_vils & ageRules.can_reach_feudal)
    world.set_rule(world.get_location("Complete " + Age2ScenarioLocationData.ATT2_VICTORY.scenario.scenario_name), attila_2_vils & ageRules.can_reach_feudal)
    world.set_rule(world.get_location(Age2ScenarioLocationData.ATT2_BUILD_TC.global_name()), attila_2_vils & ageRules.can_reach_feudal)
    world.set_rule(world.get_location(Age2ScenarioLocationData.ATT2_BEAT_THE_ROMANS.global_name()), attila_2_vils & ageRules.can_reach_feudal)
    ...
    world.set_rule(world.get_entrance(Age2ScenarioData.AP_ATTILA_4.scenario_name), ageRules.can_build_tc)