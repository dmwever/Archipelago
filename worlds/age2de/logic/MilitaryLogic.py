...
class MilitaryLogic:
    ...
    def counters_militia(self, age: Age2AgeData = Age2AgeData.DARK) -> Rule:
        return self.logic.buildings.contains_milita_counter() & self.logic.can_reach_age(age)
    
    def counters_spear(self, age: Age2AgeData = Age2AgeData.FEUDAL) -> Rule:
        return self.logic.buildings.contains_spear_counter() & self.logic.can_reach_age(age)
    
    def counters_scout(self, age: Age2AgeData = Age2AgeData.FEUDAL) -> Rule:
        return self.logic.buildings.contains_scout_counter() & self.logic.can_reach_age(age)
    
    def counters_knight(self, age: Age2AgeData = Age2AgeData.CASTLE) -> Rule:
        return self.logic.buildings.contains_knight_counter() & self.logic.can_reach_age(age)
    
    def counters_skirm(self, age: Age2AgeData = Age2AgeData.FEUDAL) -> Rule:
        return self.logic.buildings.contains_skirmisher_counter() & self.logic.can_reach_age(age)
    
    def counters_archer(self, age: Age2AgeData = Age2AgeData.FEUDAL) -> Rule:
        return self.logic.buildings.contains_archer_counter() & self.logic.can_reach_age(age)
    
    def counters_cav_archer(self, age: Age2AgeData = Age2AgeData.CASTLE) -> Rule:
        return self.logic.buildings.contains_cav_archer_counter() & self.logic.can_reach_age(age)
    ...
    def counters_scorpion(self, age: Age2AgeData = Age2AgeData.CASTLE) -> Rule:
        return self.logic.buildings.contains_scorpion_counter() & self.logic.can_reach_age(age)
    
    def counters_mangonel(self, age: Age2AgeData = Age2AgeData.CASTLE) -> Rule:
        return self.logic.buildings.contains_mangonel_counter() & self.logic.can_reach_age(age)
    ...
    def counters_centurion(self, age: Age2AgeData = Age2AgeData.CASTLE) -> Rule:
        return self.logic.buildings.contains_centurion_counter() & self.logic.can_reach_age(age)
    
    def counters_huskarl(self, age: Age2AgeData = Age2AgeData.CASTLE) -> Rule:
        return self.logic.buildings.contains_huskarl_counter() & self.logic.can_reach_age(age)
    
    def counters_legionary(self, age: Age2AgeData = Age2AgeData.CASTLE) -> Rule:
        return self.logic.buildings.contains_legionary_counter() & self.logic.can_reach_age(age)
    
    def counters_longbowman(self, age: Age2AgeData = Age2AgeData.CASTLE) -> Rule:
        return self.logic.buildings.contains_longbowman_counter() & self.logic.can_reach_age(age)
    
    def counters_mangudai(self, age: Age2AgeData = Age2AgeData.CASTLE) -> Rule:
        return self.logic.buildings.contains_mangudai_counter() & self.logic.can_reach_age(age)
    
    def counters_throwing_axeman(self, age: Age2AgeData = Age2AgeData.CASTLE) -> Rule:
        return self.logic.buildings.contains_throwing_axeman_counter() & self.logic.can_reach_age(age)
    
    def counters_war_elephant(self, age: Age2AgeData = Age2AgeData.CASTLE) -> Rule:
        return self.logic.buildings.contains_war_elephant_counter() & self.logic.can_reach_age(age)