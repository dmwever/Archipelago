...
class Attila6StartingState(ScenarioStartingState):
    ...
    def __init__(self, logic: 'Logic'):
        ...
        self.has_age[Age2AgeData.CASTLE] = logic.ages.can_reach(Age2AgeData.CASTLE) & DARK_START
        self.has_age[Age2AgeData.IMPERIAL] = logic.ages.can_reach(Age2AgeData.IMPERIAL)
