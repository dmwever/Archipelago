...
class Attila1StartingState(ScenarioStartingState):
    ...
    def __init__(self, logic: 'Logic'):
        ...
        self.has_base = self.has_bledas_camp | (logic.can_build_base() & 
            self.alternate_vils)
        self.has_age[Age2AgeData.DARK] = True_()
        self.has_age[Age2AgeData.FEUDAL] = (self.has_bledas_camp | self.alternate_vils) & logic.ages.can_reach(Age2AgeData.FEUDAL)
        self.has_age[Age2AgeData.CASTLE] = (self.has_bledas_camp | self.alternate_vils) & logic.ages.can_reach(Age2AgeData.CASTLE)
