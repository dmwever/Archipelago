...
class Attila1StartingState(ScenarioStartingState):
    ...
    def __init__(self, logic: 'Logic'):
        ...
        self.can_reach_age[Age2AgeData.FEUDAL] = (self.has_bledas_camp | self.alternate_vils) & logic.ages.can_reach(Age2AgeData.FEUDAL)
        self.can_reach_age[Age2AgeData.CASTLE] = (self.has_bledas_camp | self.alternate_vils) & logic.ages.can_reach(Age2AgeData.CASTLE)
