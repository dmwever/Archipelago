...
UNIT_TO_UPGRADE_TOKENS: dict[Age2UnitData, list[Age2ItemData]] = {
    ...
    # Trade Cog Line
    Age2UnitData.TRADE_COG: [Age2ItemData.UPGRADE_CART, Age2ItemData.UPGRADE_BOAT],
    # Teutonic Knight Line
    Age2UnitData.TEUTONIC_KNIGHT: [Age2ItemData.UPGRADE_SWORD, Age2ItemData.UPGRADE_SHIELD],
    Age2UnitData.ELITE_TEUTONIC_KNIGHT: [Age2ItemData.UPGRADE_SWORD, Age2ItemData.UPGRADE_SHIELD],
    # Bombard Cannon Line
    Age2UnitData.BOMBARD_CANNON: [Age2ItemData.UPGRADE_GUNPOWDER, Age2ItemData.UPGRADE_SIEGEWORKS, Age2ItemData.UPGRADE_CANNON],
    Age2UnitData.HOUFNICE: [Age2ItemData.UPGRADE_GUNPOWDER, Age2ItemData.UPGRADE_SIEGEWORKS, Age2ItemData.UPGRADE_CANNON],
    # Knight Line
    ...
    # Huskarl Line
    Age2UnitData.HUSKARL: [Age2ItemData.UPGRADE_SHIELD, Age2ItemData.UPGRADE_AXE],
    Age2UnitData.ELITE_HUSKARL: [Age2ItemData.UPGRADE_SHIELD, Age2ItemData.UPGRADE_AXE],
    # Janissary Line
    ...
    # Trade Cart Line
    Age2UnitData.TRADE_CART_EMPTY: [Age2ItemData.UPGRADE_CART],
    # Slinger Line
    Age2UnitData.SLINGER: [Age2ItemData.UPGRADE_SLING],
    # Woad Raider Line
    Age2UnitData.WOAD_RAIDER: [Age2ItemData.UPGRADE_AXE],
    Age2UnitData.ELITE_WOAD_RAIDER: [Age2ItemData.UPGRADE_AXE],
    # War Elephant Line
    ...
    # Petard Line
    Age2UnitData.PETARD: [Age2ItemData.UPGRADE_GUNPOWDER, Age2ItemData.UPGRADE_TORCH],
    # Scout Cavalry Line
    ...
    # Berserk Line
    Age2UnitData.BERSERK: [Age2ItemData.UPGRADE_AXE],
    Age2UnitData.ELITE_BERSERK: [Age2ItemData.UPGRADE_AXE],
    # Jaguar Warrior Line
    ...
    Age2UnitData.EAGLE_WARRIOR: [Age2ItemData.UPGRADE_SPEAR],
    Age2UnitData.ELITE_EAGLE_WARRIOR: [Age2ItemData.UPGRADE_SPEAR],
    # Tarkan Line
    ...
    Age2UnitData.GENOESE_CROSSBOWMAN: [Age2ItemData.UPGRADE_BOW, Age2ItemData.UPGRADE_BOLT],
    Age2UnitData.ELITE_GENOESE_CROSSBOWMAN: [Age2ItemData.UPGRADE_BOW, Age2ItemData.UPGRADE_BOLT],
    # Magyar Huszar Line
    Age2UnitData.MAGYAR_HUSZAR: [Age2ItemData.UPGRADE_SWORD, Age2ItemData.UPGRADE_HORSE],
    Age2UnitData.ELITE_MAGYAR_HUSZAR: [Age2ItemData.UPGRADE_SWORD, Age2ItemData.UPGRADE_HORSE],
    ...
    # Boyar Line
    Age2UnitData.BOYAR: [Age2ItemData.UPGRADE_SWORD, Age2ItemData.UPGRADE_SHIELD, Age2ItemData.UPGRADE_HORSE],
    Age2UnitData.ELITE_BOYAR: [Age2ItemData.UPGRADE_SWORD, Age2ItemData.UPGRADE_SHIELD, Age2ItemData.UPGRADE_HORSE],
    # Kamayuk Line
    Age2UnitData.KAMAYUK: [Age2ItemData.UPGRADE_SPEAR],
    Age2UnitData.ELITE_KAMAYUK: [Age2ItemData.UPGRADE_SPEAR],
    # Condottiero Line
    Age2UnitData.CONDOTTIERO: [Age2ItemData.UPGRADE_SWORD],
    # Organ Gun Line
    ...
    # Caravel Line
    Age2UnitData.CARAVEL: [Age2ItemData.UPGRADE_BOW, Age2ItemData.UPGRADE_BOAT],
    Age2UnitData.ELITE_CARAVEL: [Age2ItemData.UPGRADE_BOW, Age2ItemData.UPGRADE_BOAT],
    # Camel Archer Line
    ...
    # Genitour Line
    Age2UnitData.GENITOUR: [Age2ItemData.UPGRADE_SPEAR, Age2ItemData.UPGRADE_HORSE],
    Age2UnitData.ELITE_GENITOUR: [Age2ItemData.UPGRADE_SPEAR, Age2ItemData.UPGRADE_HORSE],
    # Gbeto Line
    ...
    # Arambai Line
    Age2UnitData.ARAMBAI: [Age2ItemData.UPGRADE_SPEAR, Age2ItemData.UPGRADE_HORSE],
    Age2UnitData.ELITE_ARAMBAI: [Age2ItemData.UPGRADE_SPEAR, Age2ItemData.UPGRADE_HORSE],
    # Rattan Archer Line
    ...
    Age2UnitData.BATTLE_ELEPHANT: [Age2ItemData.UPGRADE_ELEPHANT],
    Age2UnitData.ELITE_BATTLE_ELEPHANT: [Age2ItemData.UPGRADE_ELEPHANT],
    # Konnik Line
    Age2UnitData.KONNIK: [Age2ItemData.UPGRADE_SWORD, Age2ItemData.UPGRADE_SHIELD, Age2ItemData.UPGRADE_HORSE],
    Age2UnitData.ELITE_KONNIK: [Age2ItemData.UPGRADE_SWORD, Age2ItemData.UPGRADE_SHIELD, Age2ItemData.UPGRADE_HORSE],
    # Keshik Line
    Age2UnitData.KESHIK: [Age2ItemData.UPGRADE_SWORD, Age2ItemData.UPGRADE_HORSE],
    Age2UnitData.ELITE_KESHIK: [Age2ItemData.UPGRADE_SWORD, Age2ItemData.UPGRADE_HORSE],
    # Kipchak Line
    ...
    # Leitis Line
    Age2UnitData.LEITIS: [Age2ItemData.UPGRADE_SWORD, Age2ItemData.UPGRADE_HORSE],
    Age2UnitData.ELITE_LEITIS: [Age2ItemData.UPGRADE_SWORD, Age2ItemData.UPGRADE_HORSE],
    # Battering Ram Line
    ...
    # Serjeant Line
    Age2UnitData.SERJEANT: [Age2ItemData.UPGRADE_SWORD, Age2ItemData.UPGRADE_SHIELD],
    Age2UnitData.ELITE_SERJEANT: [Age2ItemData.UPGRADE_SWORD, Age2ItemData.UPGRADE_SHIELD],
    # Flemish Militia Line
    Age2UnitData.FLEMISH_MILITIA: [Age2ItemData.UPGRADE_SPEAR],
    # Obuch Line
    Age2UnitData.OBUCH: [Age2ItemData.UPGRADE_CLUB],
    Age2UnitData.ELITE_OBUCH: [Age2ItemData.UPGRADE_CLUB],
    # Hussite Wagon Line
    ...
    Age2UnitData.URUMI_SWORDSMAN: [Age2ItemData.UPGRADE_SWORD],
    Age2UnitData.ELITE_URUMI_SWORDSMAN: [Age2ItemData.UPGRADE_SWORD],
    ...
    # Ghulam Line
    Age2UnitData.GHULAM: [Age2ItemData.UPGRADE_SWORD],
    Age2UnitData.ELITE_GHULAM: [Age2ItemData.UPGRADE_SWORD],
    # Thirisadai Line
    Age2UnitData.THIRISADAI: [Age2ItemData.UPGRADE_BOW, Age2ItemData.UPGRADE_BOLT, Age2ItemData.UPGRADE_BOAT],
    # Shrivamsha Rider Line
    Age2UnitData.SHRIVAMSHA_RIDER: [Age2ItemData.UPGRADE_SWORD, Age2ItemData.UPGRADE_HORSE],
    Age2UnitData.ELITE_SHRIVAMSHA_RIDER: [Age2ItemData.UPGRADE_SWORD, Age2ItemData.UPGRADE_HORSE],
    # Camel Line
    Age2UnitData.CAMEL_SCOUT: [Age2ItemData.UPGRADE_CAMEL],
    Age2UnitData.CAMEL_RIDER: [Age2ItemData.UPGRADE_CAMEL],
    Age2UnitData.HEAVY_CAMEL_RIDER: [Age2ItemData.UPGRADE_CAMEL],
    Age2UnitData.IMPERIAL_CAMEL_RIDER: [Age2ItemData.UPGRADE_CAMEL],
    # Ratha Ranged Line
    Age2UnitData.RATHA_RANGED: [Age2ItemData.UPGRADE_BOW, Age2ItemData.UPGRADE_CART],
    Age2UnitData.ELITE_RATHA_RANGED: [Age2ItemData.UPGRADE_BOW, Age2ItemData.UPGRADE_CART],
    # Centurion Line
    ...
    # Monaspa Line
    Age2UnitData.MONASPA: [Age2ItemData.UPGRADE_SWORD, Age2ItemData.UPGRADE_HORSE],
    Age2UnitData.ELITE_MONASPA: [Age2ItemData.UPGRADE_SWORD, Age2ItemData.UPGRADE_HORSE],
    # Warrior Priest Line
    Age2UnitData.WARRIOR_PRIEST: [Age2ItemData.UPGRADE_SWORD, Age2ItemData.UPGRADE_BIBLE],
    # Fire Lancer Line
    Age2UnitData.FIRE_LANCER: [Age2ItemData.UPGRADE_HORSE, Age2ItemData.UPGRADE_GUNPOWDER],
    Age2UnitData.ELITE_FIRE_LANCER: [Age2ItemData.UPGRADE_HORSE, Age2ItemData.UPGRADE_GUNPOWDER],
    # Rocket Cart Line
    ...
    # Iron Pagoda Line
    Age2UnitData.IRON_PAGODA: [Age2ItemData.UPGRADE_SWORD, Age2ItemData.UPGRADE_SHIELD, Age2ItemData.UPGRADE_HORSE],
    Age2UnitData.ELITE_IRON_PAGODA: [Age2ItemData.UPGRADE_SWORD, Age2ItemData.UPGRADE_SHIELD, Age2ItemData.UPGRADE_HORSE],
    # Grenadier Line
    ...
    Age2UnitData.HEI_GUANG_CAVALRY: [Age2ItemData.UPGRADE_SWORD, Age2ItemData.UPGRADE_SHIELD, Age2ItemData.UPGRADE_HORSE],
    Age2UnitData.HEAVY_HEI_GUANG_CAVALRY: [Age2ItemData.UPGRADE_SWORD, Age2ItemData.UPGRADE_SHIELD, Age2ItemData.UPGRADE_HORSE],
    # Lou Chuan Line
    Age2UnitData.LOU_CHUAN: [Age2ItemData.UPGRADE_BOW, Age2ItemData.UPGRADE_BOLT, Age2ItemData.UPGRADE_BOAT],
    # Tiger Cavalry Line
    Age2UnitData.TIGER_CAVALRY: [Age2ItemData.UPGRADE_SWORD, Age2ItemData.UPGRADE_HORSE],
    Age2UnitData.ELITE_TIGER_CAVALRY: [Age2ItemData.UPGRADE_SWORD, Age2ItemData.UPGRADE_HORSE],
    # Xianbei Raider Line
    ...
    # Jian Swordsman Line
    Age2UnitData.JIAN_SWORDSMAN: [Age2ItemData.UPGRADE_SWORD],
    # Champi Line
    Age2UnitData.CHAMPI_SCOUT: [Age2ItemData.UPGRADE_CLUB],
    Age2UnitData.CHAMPI_RUNNER: [Age2ItemData.UPGRADE_CLUB],
    Age2UnitData.CHAMPI_WARRIOR: [Age2ItemData.UPGRADE_CLUB],
    Age2UnitData.ELITE_CHAMPI_WARRIOR: [Age2ItemData.UPGRADE_CLUB],
    # Guecha Warrior Line
    Age2UnitData.GUECHA_WARRIOR: [Age2ItemData.UPGRADE_SPEAR],
    Age2UnitData.ELITE_GUECHA_WARRIOR: [Age2ItemData.UPGRADE_SPEAR],
    # Kona Line
    Age2UnitData.KONA: [Age2ItemData.UPGRADE_CLUB],
    Age2UnitData.ELITE_KONA: [Age2ItemData.UPGRADE_CLUB],
    # Bolas Rider Line
    ...
    # Hearth Troop Line
    Age2UnitData.HEARTH_TROOP: [Age2ItemData.UPGRADE_SWORD, Age2ItemData.UPGRADE_SHIELD],
    Age2UnitData.ELITE_HEARTH_TROOP: [Age2ItemData.UPGRADE_SWORD, Age2ItemData.UPGRADE_SHIELD],
    # Jarl Line
    Age2UnitData.JARL: [Age2ItemData.UPGRADE_SWORD, Age2ItemData.UPGRADE_SHIELD, Age2ItemData.UPGRADE_HORSE],
    Age2UnitData.ELITE_JARL: [Age2ItemData.UPGRADE_SWORD, Age2ItemData.UPGRADE_SHIELD, Age2ItemData.UPGRADE_HORSE],
    # Jomsviking Line
    Age2UnitData.JOMSVIKING: [Age2ItemData.UPGRADE_SHIELD, Age2ItemData.UPGRADE_AXE],
    Age2UnitData.ELITE_JOMSVIKING: [Age2ItemData.UPGRADE_SHIELD, Age2ItemData.UPGRADE_AXE],
}
...
assert not [unit for unit in Age2UnitData
            ...
            and unit is not Age2UnitData.VILLAGER_MALE], \
