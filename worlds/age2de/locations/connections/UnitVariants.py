...
UNIT_TO_VARIANT_IDS: dict[Age2UnitData, list[int]] = {
    ...
    Age2UnitData.VILLAGER_MALE: [118, 120, 122, 123, 124, 156, 259, 579, 592, 1810, 1892, 2333],
    Age2UnitData.SPEARMAN: [1786],
    Age2UnitData.VILLAGER_FEMALE: [212, 214, 216, 218, 220, 222, 354, 581, 590, 1891, 2334],
